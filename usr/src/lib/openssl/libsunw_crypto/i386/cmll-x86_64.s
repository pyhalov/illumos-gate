...
.globl	sunw_Camellia_EncryptBlock
.type	sunw_Camellia_EncryptBlock,@function
.align	16
sunw_Camellia_EncryptBlock:
	movl	$128,%eax
	subl	%edi,%eax
	movl	$3,%edi
	adcl	$0,%edi
	jmp	.Lenc_rounds
.size	sunw_Camellia_EncryptBlock,.-sunw_Camellia_EncryptBlock

.globl	sunw_Camellia_EncryptBlock_Rounds
.type	sunw_Camellia_EncryptBlock_Rounds,@function
.align	16
.Lenc_rounds:
sunw_Camellia_EncryptBlock_Rounds:
	pushq	%rbx
	pushq	%rbp
	pushq	%r13
	pushq	%r14
...
.Lenc_epilogue:
	.byte	0xf3,0xc3
.size	sunw_Camellia_EncryptBlock_Rounds,.-sunw_Camellia_EncryptBlock_Rounds
...
.globl	sunw_Camellia_DecryptBlock
.type	sunw_Camellia_DecryptBlock,@function
.align	16
sunw_Camellia_DecryptBlock:
	movl	$128,%eax
	subl	%edi,%eax
	movl	$3,%edi
	adcl	$0,%edi
	jmp	.Ldec_rounds
.size	sunw_Camellia_DecryptBlock,.-sunw_Camellia_DecryptBlock

.globl	sunw_Camellia_DecryptBlock_Rounds
.type	sunw_Camellia_DecryptBlock_Rounds,@function
.align	16
.Ldec_rounds:
sunw_Camellia_DecryptBlock_Rounds:
	pushq	%rbx
	pushq	%rbp
	pushq	%r13
	pushq	%r14
...
.Ldec_epilogue:
	.byte	0xf3,0xc3
.size	sunw_Camellia_DecryptBlock_Rounds,.-sunw_Camellia_DecryptBlock_Rounds
...
.globl	sunw_Camellia_Ekeygen
.type	sunw_Camellia_Ekeygen,@function
.align	16
sunw_Camellia_Ekeygen:
	pushq	%rbx
	pushq	%rbp
	pushq	%r13
	pushq	%r14
...
.Lkey_epilogue:
	.byte	0xf3,0xc3
.size	sunw_Camellia_Ekeygen,.-sunw_Camellia_Ekeygen
.align	64
.LCamellia_SIGMA:
...
.globl	sunw_Camellia_cbc_encrypt
.type	sunw_Camellia_cbc_encrypt,@function
.align	16
sunw_Camellia_cbc_encrypt:
	cmpq	$0,%rdx
	je	.Lcbc_abort
	pushq	%rbx
	pushq	%rbp
...
.Lcbc_abort:
	.byte	0xf3,0xc3
.size	sunw_Camellia_cbc_encrypt,.-sunw_Camellia_cbc_encrypt
